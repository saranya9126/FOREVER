    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e) => setPrice(e.target.value)} className='w-full sm:w-[120px] px-3 py-2' type="number" placeholder='25' />
        </div>
      ...
      <button className='w-28 py-3 mt-4 bg-black rounded-lg text-white cursor-pointer'>ADD</button>
    </form>
